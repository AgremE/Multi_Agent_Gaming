...
// This player is using experience on guassing what the card might be in other player hand
// The likelihood of the event itself is constructing from simulated game play of about NN time

public class BayesianPlayer extends Player {
	
	public BayesianPlayer(BoardLayout bl, int position){
