//Remember there is only one POMDPs player in the game
/*
 * Make another variable to track who stealing within SOC player in ResourceSet class with add and substract overloading function
...
public interface POMDPsConstant extends GameStateConstants {
	
	public final int POMDPPLAYER_NUM = 0;
...
int NPLAYERS = 2;// Change into semi zero sum game
    ...
    // TODO: Change the state of environment to 
        ...
        int OFS_STEALCARD			= OFS_HASPLAYEDCARD + NRESOURCES;// To store the steal card and to prevent the other player to know that state
        int OFS_NSTEALRESOURCES		= OFS_STEALCARD + 1; // To keep track of how many card that particular player has been steal
        int OFS_RESOURCES           = OFS_STEALCARD   +1;
    ...
    //TODO: Hide the imperfect information right here in the OFS_PLAYERDATA
